"""End-to-end tests for the zreport command-line client against a live test server.
...
class CliTest(unittest.TestCase):
    ...
    def test_device_login_saves_token_and_cli_workflow(self):
        ...
        def run_login():
            with mock.patch("zreport.time.sleep", new=lambda seconds: None), redirect_stdout(io.StringIO()):
                login_result["code"] = zreport.main(
