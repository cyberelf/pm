...
class FrontendTest(unittest.TestCase):
    ...
    def test_todo_board_is_separate_and_closure_collects_required_context(self):
        ...
        self.assertIn('.page-corner:hover .page-corner-fold,', styles)
        self.assertIn('clip-path: polygon(0 0, 100% 0, 100% 100%);', styles)
        self.assertIn('filter: drop-shadow(-7px 8px 8px rgba(15, 23, 42, 0.22));', styles)
        ...
        self.assertIn('#todo-view { min-height: 100vh; background: #172033; }', styles)
