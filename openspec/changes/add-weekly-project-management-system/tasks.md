...
- [x] 8.4 Implement deterministic source and generation health warnings for failed report generation, unavailable local `gh`, inaccessible GitHub repositories, and material extraction failures
...
- [x] 9.6 Add tests for progress status, deterministic risk warning rules, source/generation health warnings, no promotion action for generated report risk forecasts, and separation of generated report risk forecasts from system warnings
