...
- Track progress and generate system risk warnings from deterministic rules over plan status, missing updates, source availability, and generation health.
